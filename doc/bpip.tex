...
equality constraints, by introducing auxiliary variables and then solved using the simplex method. \boste{Jeg ved ikke 
om jeg skal uddybe det mere i.e Dual problem, når jeg kun beskæftiger mig med BP/IP} \\ 
