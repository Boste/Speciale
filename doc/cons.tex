...
The variables will be restricted by $C$ that is a set of $m$ constraints $C= \{ 
...
$c_j \in C$. \boste{Er det helt rigtigt?}\\ 
...
problem. \\ \\ 
\subsection{Considered Constriants \boste{Not sure about the title and not finished yet}}
