...
\label{tab_neighb}
\end{table}
The \class{RestrictedFlipNE} class chooses a variable for the next move with probability $p = \frac{5000}{n}$, where 
...
\class{RandomConflictFlipNE} the neighborhood size can change after each step, for the others it is a constant size. \\ 
