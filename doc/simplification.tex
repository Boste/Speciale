Each functional constraint can be used to define a variable making it dependent on other variables or invariants. The 
...
\tcp{Move right hand side to left hand side}
